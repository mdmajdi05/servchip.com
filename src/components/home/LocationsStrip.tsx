...
const REGION_GROUPS: {
...
}[] = [
  {
    ...
    links: [
      ...
      { label: "NVIDIA distributor in Singapore", href: "/products" },
      { label: "NVIDIA distributor in Malaysia", href: "/products" },
      { label: "NVIDIA distributor in China", href: "/products" },
      { label: "NVIDIA distributor in Philippines", href: "/products" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Intel supplier in Malaysia", href: "/products" },
