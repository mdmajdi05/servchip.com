...
export default function IndustryPage() {
  ...
  const brandIds = industry.related?.brandIds ?? [];
  const categoryIds = industry.related?.categoryIds ?? [];
  const useCases = industry.related?.useCases ?? [];
    ...
    <div className="min-h-screen bg-bg-dark">
      ...
      <section className="py-16 bg-bg-body">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <SectionHeading
            label={industry.name}
            title={`Enterprise AI Solutions for ${industry.name}`}
          ...
          {relatedBrands.length > 0 && (
            <div className="mt-10">
              <SectionHeading
                ...
                subtitle={`Leading brands powering ${industry.name} deployments`}
                align="center"
              />
      ...
      <section className="py-16 bg-bg-dark">
        <div className="max-w-7xl mx-auto px-4">
          <SectionHeading
            label="Products"
            title={`Hardware for ${industry.name}`}
            subtitle="AI accelerators, servers, networking and storage suited to your workloads"
            align="center"
          />
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="rounded-2xl border border-primary/20 bg-surface/50 p-8 text-center">
            ...
            <p className="text-sm text-text-muted mb-6 max-w-md mx-auto">
              Talk to our engineers about reference architectures and hardware
              for {industry.name.toLowerCase()} workloads.
            </p>
