...
export const COUNTRY_SEO: Record<string, SeoEntry> = {
  uae: {
    metaTitle: "AI Chip Distributor UAE & Dubai | Data Center GPUs | Servchip",
    metaDescription:
      "Servchip is an ISO certified AI chip distributor in UAE & Dubai, sourcing NVIDIA H100, H200, B200, AMD MI300X & Intel Gaudi GPUs for enterprise data centers.",
    keywords: [
  ...
  usa: {
    ...
    metaDescription:
      "Buy NVIDIA H100, H200, AMD Instinct MI300X & Intel Xeon AI chips in the USA. Authorized enterprise chip distributor with full US export compliance support.",
    keywords: [
  ...
  oman: {
    ...
    metaDescription:
      "NVIDIA, AMD & Intel AI accelerator distributor in Oman. Enterprise GPU and data center hardware supply for Muscat, Sohar and across the Sultanate.",
    keywords: [
  ...
  singapore: {
    ...
    metaDescription:
      "Buy NVIDIA H100, H200, B200, AMD Instinct & Intel Gaudi AI chips in Singapore with authentic, warrantied hardware and fast delivery across the island.",
    keywords: [
  ...
  china: {
    ...
    metaDescription:
      "Enterprise NVIDIA, AMD & Intel AI chip distribution for China. Authentic data center GPUs and accelerators with compliance documentation and support.",
    keywords: [
  ...
  philippines: {
    ...
    metaDescription:
      "Buy NVIDIA H100, H200, B200, AMD Instinct & Intel Gaudi AI chips in the Philippines with authentic hardware and fast delivery across Manila and beyond.",
    keywords: [
