...
export const TRUST_BAR_ITEMS: TrustBarItem[] = [
  { icon: "Zap", text: "Enterprise Chip Distributor", badge: "Star" },
  { icon: "CheckCircle", text: "ISO 9001:2015 Certified" },
  { icon: "Building2", text: "NVIDIA" },
  { icon: "Building2", text: "Intel" },
  { icon: "Building2", text: "AMD" },
  { icon: "Building2", text: "Broadcom" },
  { icon: "Building2", text: "Marvell" },
  { icon: "Building2", text: "Cisco" },
  { icon: "Building2", text: "Qualcomm" },
  { icon: "Building2", text: "Samsung" },
  { icon: "Building2", text: "Micron" },
  { icon: "Building2", text: "SK hynix" },
  { icon: "Building2", text: "Seagate" },
  { icon: "Building2", text: "Dell" },
